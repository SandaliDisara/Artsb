...
export default function HeroSection() {
  ...
  <div className={styles.artItem2}>
    ...
    <p>invites viewers to pause, reflect, and lose themselves in stories told through color</p>
  </div>

  <div className={styles.artItem3}>
    <img src="/images/angel.png" alt="Art 3" />
    <p>With each piece, they craft a visual language that is both deeply personal and universally resonant.</p>
  </div>
</div>
